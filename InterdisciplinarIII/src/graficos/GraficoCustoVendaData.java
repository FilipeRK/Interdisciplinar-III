...
public class GraficoCustoVendaData extends javax.swing.JFrame {

    public GraficoCustoVendaData() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraficoCustoVendaData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraficoCustoVendaData().setVisible(true);
            }
        });
    }
    ...
    private CategoryDataset createDataset() { 
        ...
        for(CustoVenda cv : dao.findAllTeste(datainicial,datafinal)){
    ...
    public void criaGrafico() {
        ...
        String titulo = "Custos e Lucros por Data";
    ...
    public void abreJanelaGraficoData(){

        this.setLocationRelativeTo(null);
        this.setLayout(new BorderLayout());
        this.setTitle("Gráfico dos Custos e Lucros por Data");
